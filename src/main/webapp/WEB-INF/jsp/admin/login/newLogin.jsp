		...
		<div class="login_c">
			<form id="login">
				...
				<ul>
					...
					<li><input value="admin" type="text" class="dl_tu dl_tu1" placeholder="请输入用户名" id="userName" name="userName"></li>
					<li><input value="a123123" type="password" class="dl_tu dl_tu2" placeholder="请输入密码" id="userPwd" name="userPwd"></li>
